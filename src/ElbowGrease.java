...
public class ElbowGrease extends WashBehavior{
    ...
    private double likeNewChance = 10;
    ...
    public void Wash(Vehicle v, Intern i, FNCD f){
        // System.out.println("Intern washing with elbow grease wash behavior");
        f.jo.NotifyObserver("Intern washing with Elbow Grease wash behavior", 0, 0);
        ...
        // 10 % chance of becoming like new
        num = ThreadLocalRandom.current().nextInt(1,101); // 1-100
        if(num <= 10){
            v.SetState("Like New");
            // System.out.print("Vehicle also became like new from being washed");
