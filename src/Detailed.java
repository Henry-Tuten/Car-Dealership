...
public class Detailed extends WashBehavior{
    ...
    public void Wash(Vehicle v, Intern i, FNCD f){
        // System.out.println("Intern washing with Detailed wash behavior");
        f.jo.NotifyObserver("Intern washing with Detailed wash behavior", 0, 0);
